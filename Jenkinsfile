pipeline {
    ...
    stages {
        ...
        stage('Git clone') {
            steps {
                git branch: 'main', url: 'https://github.com/rajeshrj-git/java-maven-app.git'
            }
        }
            ...
            steps {
                script{
                    withDockerRegistry(credentialsId: 'docker', toolname: 'docker'){
                        ...
                        docker tag javamavenapp rajeshchoco/javamavenapp:latest
                        docker push  rajeshchoco/javamavenapp:latest'''
                      } 
                }
            }
        }
